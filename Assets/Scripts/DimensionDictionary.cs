...
public static class DimensionDictionary
{
    private static readonly Dictionary<PlaceableDimension, Vector2[]> dimensionDic = new Dictionary<PlaceableDimension, Vector2[]>()
    {
        ...
        { PlaceableDimension.TwoByThree, new []{ Vector2.zero, Vector2.right, Vector2.up, Vector2.down, Vector2.right + Vector2.up, Vector2.right + Vector2.down}},
        { PlaceableDimension.FourByFour, new []{ Vector2.zero, Vector2.up, Vector2.right, Vector2.right + Vector2.up }}
    };
